...
def dedv_dt6(atilde, rat, ec, vm):
    ...
    dedt8_c= 1e0+121e0/304*ec**2+(-6849e0/2128-2325e0/2128*\
         ...
         # 2053643e0/29184*np.pi*atilde**2*cosuta**2)*ec**4)*vm**7\
         # +\
         # (20995469e0/48384*atilde**2*cosuta**2-5673e0/133*np.pi**2-9392e0/\
...
def evolve(atilde, rat, ec, vm, timeVec):
    ...
    def odeg(vrb, t):#return de_dt, dv_dt every step
        ...
        de_dt, dv_dt = dedv_dt6(atilde, rat, ec, vm)
        return de_dt,dv_dt 
...
if __name__ == '__main__':
    ...
    e_Vec, vm_Vec =  evolve_hacc6(atilde, rat, e, vm, timeVecm) #e Vector and a Vector
    ...
    #plot t and p(rp)
    plt.subplot(2,2,1)  
    plt.plot(timeVeckm, pm_Vec, label = 'haccu6-pm')  
    plt.plot(timeVeckm, rp_Vec, label = 'haccu6-rp')
    ...
    #plot e and p
    plt.subplot(2,2,2)    
    plt.plot(e_Vec, pm_Vec, label = 'haccu6-pm')
    ...
    plt.plot( e_Vec, timeVeckm, label = 'haccu6')
    plt.xlabel('e')
    plt.ylabel('t/kM')
    plt.legend()
    plt.show()